        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => (
              <Link key={article.slug} href={`/articles/japanesetea/recomend/${article.slug}`} className="group">
...
export const getStaticProps: GetStaticProps<RecomendIndexProps> = async () => {
  const articlesDirectory = path.join(process.cwd(), 'articles', 'japanesetea', 'recomend');
