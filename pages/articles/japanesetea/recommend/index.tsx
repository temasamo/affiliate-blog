// pages/articles/japanesetea/recomend/index.tsx
...
export default function RecomendIndex({ articles }: RecomendIndexProps) {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header 
        title="おすすめ商品一覧 - 日本茶 | Market Supporter AI"
        description="日本茶に関するおすすめ商品の過去記事一覧です。"
      />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="bg-white rounded-2xl shadow-md p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">日本茶に関するおすすめ商品の過去記事をすべて表示しています。</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => (
              <Link key={article.slug} href={`/articles/japanesetea/recommend/${article.slug}`} className="group">
...
export const getStaticProps: GetStaticProps<RecomendIndexProps> = async () => {
  const articlesDirectory = path.join(process.cwd(), 'articles', 'japanesetea', 'recommend');
