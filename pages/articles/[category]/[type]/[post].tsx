...
{post === '250731kyusu-ranking-top5-with-frontmatter' && (
  <section className="mt-8">
    ...
    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
      <div className="text-center">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">HARIO 茶茶急須 丸 CHJMN-45T</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          <a 
            href="https://search.rakuten.co.jp/search/mall/HARIO+茶茶急須+丸+CHJMN-45T/" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://shopping.yahoo.co.jp/search?p=HARIO+茶茶急須+丸+CHJMN-45T" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://www.amazon.co.jp/s?k=HARIO+茶茶急須+丸+CHJMN-45T" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
    ...
    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
      <div className="text-center">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">常滑焼 山房製作所 セラメッシュ急須 400ml</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          <a 
            href="https://search.rakuten.co.jp/search/mall/常滑焼+山房製作所+セラメッシュ急須/" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://shopping.yahoo.co.jp/search?p=常滑焼+山房製作所+セラメッシュ急須" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://www.amazon.co.jp/s?k=常滑焼+山房製作所+セラメッシュ急須" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
    ...
    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
      <div className="text-center">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">香蘭社 有田焼 急須 桜絵付け 420ml</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          <a 
            href="https://search.rakuten.co.jp/search/mall/香蘭社+有田焼+急須+桜絵付け/" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://shopping.yahoo.co.jp/search?p=香蘭社+有田焼+急須+桜絵付け" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://www.amazon.co.jp/s?k=香蘭社+有田焼+急須+桜絵付け" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
    ...
    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
      <div className="text-center">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">岩鋳 南部鉄器 急須 アラレ 0.55L</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          <a 
            href="https://search.rakuten.co.jp/search/mall/岩鋳+南部鉄器+急須+アラレ/" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://shopping.yahoo.co.jp/search?p=岩鋳+南部鉄器+急須+アラレ" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://www.amazon.co.jp/s?k=岩鋳+南部鉄器+急須+アラレ" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
    ...
    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
      <div className="text-center">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">柳宗理 ステンレス急須 700ml</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          <a 
            href="https://search.rakuten.co.jp/search/mall/柳宗理+ステンレス急須/" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://shopping.yahoo.co.jp/search?p=柳宗理+ステンレス急須" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
          ...
          <a 
            href="https://www.amazon.co.jp/s?k=柳宗理+ステンレス急須" 
            target="_blank" 
            rel="nofollow noopener noreferrer"
            className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
          >
