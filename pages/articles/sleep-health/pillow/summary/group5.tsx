...
export default function Group5Summary({ frontMatter, mdxSource }: { frontMatter: any; mdxSource: any; }) {
  return (
        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <Link href="/articles/sleep-health/pillow/group5" className="inline-flex items-center text-blue-600 hover:text-blue-800">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
                グループ5（朝スッキリ編）一覧に戻る
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), "articles", "sleep-health", "pillow", "summary", "pillow-summary-group5.mdx");
