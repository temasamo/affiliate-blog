...
export default function Group2Summary({ frontMatter, mdxSource }: { frontMatter: any; mdxSource: any; }) {
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="bg-white rounded-2xl shadow-md p-8">
          <div className="mb-8">
            <Link href="/articles/sleep-health/pillow/group2" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-4" >
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), "articles", "sleep-health", "pillow", "summary", "pillow-summary-group2.mdx");
