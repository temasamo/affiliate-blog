...
export default function Group6Index({ articles }: { articles: Article[] }) {
  return (
        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((a) => (
              <Link
                key={a.slug}
                href={`/articles/sleep-health/pillow/group6/${a.slug}`}
                className="group"
              >
                <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
...
export async function getStaticProps() {
  const dir = path.join(process.cwd(), "articles", "sleep-health", "pillow", "group6");
    ...
    files
      ...
      .forEach((file) => {
        ...
        articles.push({
          ...
          date: frontMatter.date || "2025.10.16",
        });
      });
  }
