// pages/articles/whisky/diagnosis/index.tsx
import React from 'react';
import Link from 'next/link';
import Header from '../../../../components/Header';
import Footer from '../../../../components/Footer';

export default function WhiskyDiagnosisConstruction() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header 
        title="ウイスキー診断AI - 工事中 | Market Supporter AI"
        description="ウイスキー診断AIは現在開発中です。近日公開予定です。"
      />
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 sm:p-12 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <p className="text-lg text-gray-600 mb-4">
              あなたの好みやシーンに合わせて、最適なウイスキーを提案する
              <strong className="text-gray-900">診断AI</strong>を開発中です。
            </p>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-900">今すぐウイスキーについて学ぶ</h2>
