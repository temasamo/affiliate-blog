          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover-lift scale-hover">
              ...
              <div className="p-6">
                ...
                <Link href="/articles/japaneseproducts-popular-with-foreigners/recomend/250731popular-japanese-foods-2025-dm" className="text-red-600 hover:text-red-800 text-sm font-medium inline-flex items-center transition-colors">
                  詳細を見る
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
