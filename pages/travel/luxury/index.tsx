...
export default function LuxuryOnsenIndex({ posts }: { posts: any[] }) {
  const luxuryPosts = posts
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header 
        title="高級温泉旅館ガイド - Market Supporter AI"
        description="日本各地の高級温泉旅館ランキングをご紹介。"
      />
        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          ...
          <nav className="mb-8">
            <ol className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <li>/</li>
              <li className="text-gray-900">高級温泉旅館ガイド</li>
            </ol>
          </nav>
          
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">🏯 高級温泉旅館ガイド</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              日本各地の高級温泉旅館ランキングをご紹介します。
            </p>
          </div>
