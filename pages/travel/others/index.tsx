...
export default function OthersIndex({ posts }: { posts: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header 
        title="その他 - Market Supporter AI"
        description="旅行に関するその他の記事をご紹介。"
      />
        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          ...
          <nav className="mb-8">
            <ol className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <li>/</li>
              <li className="text-gray-900">その他</li>
            </ol>
          </nav>
          
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">🗾 その他</h1>
