        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <Link 
                href="/events/birthday/chat?category=高級お茶セット&target=実母"
                className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-2 px-4 rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all duration-300 text-center block"
              >
                🤖 AI相談で選ぶ
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center justify-between mb-3">
                <span className="text-lg font-bold text-blue-600">¥5,000〜¥20,000</span>
                <Link 
                  href="https://www.rakuten.co.jp/" 
                  className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                >
